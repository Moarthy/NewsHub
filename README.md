...
| `npm run typecheck` | بررسی سخت‌گیرانهٔ TypeScript بدون تولید فایل |
...
| Language | TypeScript 7.0, Node ≥ 20.18 |
| Scripts | `tsx` |
